...
1.  [`find_cutpoint_number()`](https://paytonyau.github.io/OptSurvCutR/dev/reference/find_cutpoint_number.md):
    – selects the statistically optimal number of cut-points using
    information criteria
2.  [`find_cutpoint()`](https://paytonyau.github.io/OptSurvCutR/dev/reference/find_cutpoint.md):
    locates exact cut-point values (systematic or genetic search)
3.  [`validate_cutpoint()`](https://paytonyau.github.io/OptSurvCutR/dev/reference/validate_cutpoint.md):
