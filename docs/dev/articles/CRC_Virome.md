...
We first run
[`find_cutpoint_number()`](https://paytonyau.github.io/OptSurvCutR/dev/reference/find_cutpoint_number.md)
...
#>         0 1258.74      6.95       1.6%    Moderate                    NA
#>         1 1251.79      0.00      51.7% Substantial                  2.36
#>         2      NA        NA        NA%        <NA>                    NA
#>         3 1252.59      0.80      34.6% Substantial      1.61, 1.79, 2.36
#>         4 1254.69      2.90      12.1%    Moderate 1.52, 1.7, 1.86, 2.36
```
...
# Show plots sequentially (removing patchwork dependency)
...
![](CRC_Virome_files/figure-html/find-number-plots-2.png) \>
...
[`find_cutpoint()`](https://paytonyau.github.io/OptSurvCutR/dev/reference/find_cutpoint.md)
...
![](CRC_Virome_files/figure-html/find-cuts-plot-2.png)
...
are. We use
[`validate_cutpoint()`](https://paytonyau.github.io/OptSurvCutR/dev/reference/validate_cutpoint.md)
...
#> 25%  Cut1 1.865 0.182  1.818 1.753 1.893
#> 25%1 Cut2 2.384 0.234  2.356 2.348 2.361
#> 
...
&nbsp;
    ...
    #> [7] dplyr_1.1.4         OptSurvCutR_0.1.9.1
    #> 
