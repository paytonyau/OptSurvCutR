...
- **G3.1a Compliance — Schoenfeld Residual Diagnostics**: Added
  [`plot_diagnostics()`](https://paytonyau.github.io/OptSurvCutR/reference/plot_diagnostics.md)
  to generate publication-ready Schoenfeld residual plots, assessing the
