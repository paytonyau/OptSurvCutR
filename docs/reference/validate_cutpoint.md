...
- use_parallel:
  ...
  Logical. Use multiple CPU cores?

- n_cores:

  Number of cores for parallel. \`NULL\` defaults to 2.
...
#> ℹ Running 20 replicates sequentially...
...
#> 25% Cut1 3.004 1.231  3.275 1.838 3.764
#> 
