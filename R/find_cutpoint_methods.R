...
summary.find_cutpoint <- function(object, show_model = TRUE, show_group_counts = TRUE,
  ...
  # --- THE TROUBLESHOOTING FAILURE CATCHER ---
  ...
  if (show_group_counts || show_medians) {
    ...
    if (show_medians) {
      ...
      # Map structural coordinates based on dimension layout
      ...
      # MERGE EXTRACTION: Calculate actual landmark overall survival probabilities %
