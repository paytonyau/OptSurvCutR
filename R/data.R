...
#' .
#' @srrstats {G1.4} Example data provided.
#' @srrstats {G1.4a} Fully documented with source, structure, variables.
#'
...
#'   \item{time_months}{Overall survival (months), censored 60 mos. (numeric).}
