...
# Use OptSurvCutR's built-in diagnostic plotter
# This handles titles and subtitles automatically
plot_cutpoint_residuals(validation_result_adj, type = "schoenfeld") 
# Note: If your function takes the 'find_cutpoint' object, pass that. 
# If it takes the cox.zph object, pass that. 
# Based on your code, it takes the result object 'x':
plot_cutpoint_residuals(cutpoint_result_adj)
```
